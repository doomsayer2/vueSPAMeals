<template>
<span>
    <v-navigation-drawer app v-model="drawer" class="deep-orange lighten-1" dark disable-resize-watcher>
        <v-list>
    ...
    <v-toolbar app color="blue-grey darken-4" dark>
        ...
        <div v-if="!isAuthenticated" class="hidden-sm-and-down">
            ...
            <v-btn color="deep-orange darken-3" class="hidden-sm-and-down" to="/join">JOIN</v-btn>
        </div>
        <div v-else>
